...
HD_PWD='D:/LAB SOC/LAB 2/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemDemo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SystemDemo.tcl -notrace
