...
HD_PWD='D:/LAB SOC/LAB 2/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemDemo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemDemo.tcl
